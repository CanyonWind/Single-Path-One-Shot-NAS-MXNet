...
python train_imagenet.py \
    ...
    --save-dir params_shufflenas_supernet_60cs --logging-file ./logs/shufflenas_supernet_60cs.log \
    --epoch-start-cs 60 --use-se --last-conv-after-pooling --channels-layout OneShot
