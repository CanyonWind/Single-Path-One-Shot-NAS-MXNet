...
python train_imagenet.py \
    ...
    --resume-epoch 22 --resume-params ./params_shufflenas_supernet/0.9988-imagenet-ShuffleNas-21-best.params \
     --resume-states ./params_shufflenas_supernet/0.9988-imagenet-ShuffleNas-21-best.states \
